...
const popup__close_login = document.querySelector(".popup__close_login");
const login_parent = document.querySelector(".login_parent");
if (login_parent) {
  login.addEventListener("click", (e) => {
    login_parent.classList.add("show");
  });
  popup__close_login.addEventListener("click", (e) => {
    login_parent.classList.remove("show");
  });
}
/*
=============
